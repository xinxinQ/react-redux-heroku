      ...
      <div>
        ...
        <div className="container">
          ...
          <div>
            ...
            <ul>
              <li>
                <strong>可预测</strong>：Redux只有一颗全局state树，想要修改它只能发起action，reducer又是纯函数，
          ...
          <div>
            ...
            <p>
              ...
              还可以将按需加载的模块进行代码分隔，等到实际需要的时候再异步加载。通过
              loader 的转换，任何形式的资源都可以视作模块，比如CommonJs模块、AMD模块、ES2015模块、CSS、图片、JSON、Coffeescript、LESS等。
            </p>
